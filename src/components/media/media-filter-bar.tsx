  ...
  render() {
    ...
    return mode === 'volumes' ? (
      <div>
        ...
        />
        <IconButton id="mt-media-search" color="primary" onClick={e => this.onSearch()}>
          <SearchIcon />
        </IconButton>
        <Button variant="contained" onClick={e => this.props.onNewVolume()} id="mt-new-volume" color="primary">
      ...
      <div>
        <Button style={{ margin: '5px 0 0 0' }} onClick={e => this.props.onBack()} id="mt-cancel-volume">
